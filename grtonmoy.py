...
\033[1;91m☞ Auther     : gr_tonmoy
\033[1;92m☞ WhatsApp   : 01764156042
\033[1;95m☞ YouTube    : https://www.youtube.com/tonmoy
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' gr Tonmoy  Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Tm_05  WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://https://github.com/grtonmoy05')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 01764156042✓')
	    psb('WellCome To gr Tonmoy ')
	    psb('Congratulations tm_05 Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ gr✓')
	    psb('🔓Password ☆ tonmoy✓')
	    psb('Subscrib My Youtube Channel B4 Tonmoy-ahmed-nahid✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/tm_05 && python2 grtonmoy.py')
	elif bm =='3':
